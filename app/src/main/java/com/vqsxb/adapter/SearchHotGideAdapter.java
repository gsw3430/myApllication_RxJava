...
public class SearchHotGideAdapter extends BaseQuickAdapter<SearchInfo, BaseViewHolder> {
    private Activity activity;
    List<SearchInfo> list;
    public SearchHotGideAdapter(Activity activity, List<SearchInfo> list) {
