...
public class OnlineRankHolder extends BaseViewHolder {

    private ImageView rank_manager_item_icon;
    private TextView rank_manager_title,rank_manager_score,rank_manager_item_number;
    private FlowLayout mFlowLayout;
    private MyRatingBar rank_manager_star;
    private View itemView;

    public OnlineRankHolder(View itemView) {
        super(itemView);
