 ...
 */
public class HeadTabLayout extends HorizontalScrollView implements ViewPager.OnPageChangeListener {
    ...
    private void obtainAttributes(Context context, AttributeSet attrs) {
        ...
        mTextUnselectColor = ta.getColor(R.styleable.SlidingTabLayout_tl_textUnselectColor, Color.parseColor("#737373"));
     ...
     * 设置tab的背景
     */
    private void setTextBg(TextView txtTab, int index, int curPosition) {
        if (index == curPosition) {
            txtTab.setBackground(getResources().getDrawable(R.drawable.bg_green_round));
        } else {
            txtTab.setBackground(getResources().getDrawable(R.drawable.bg_gray_round));
        }
    }
    ...
    public void notifyDataSetChanged() {
        ...
        for (int i = 0; i < mTabCount; i++) {
            tabView = View.inflate(mContext, R.layout.head_tab_layout, null);
    ...
    public void addNewTab(String title) {
        View tabView = View.inflate(mContext, R.layout.head_tab_layout, null);
        if (mTitles != null) {
            mTitles.add(title);
        }
...
//            v.setPadding((int) mTabPadding, v.getPaddingTop(), (int) mTabPadding, v.getPaddingBottom());
            ...
            if (tv_tab_title != null) {
                if (isSetBg){
                    setTextBg(tv_tab_title, i, mCurrentTab);
                }
    ...
    private void updateTabSelection(int position) {
        for (int i = 0; i < mTabCount; ++i) {
            ...
            if (tab_title != null) {
                if (isSetBg){
                    setTextBg(tab_title, i, position);
                }
