...
public class StarRatingBar extends LinearLayout {
    ...
    public StarRatingBar(Context context, @Nullable AttributeSet attrs) {
        ...
        starImageSize=a.getDimension(R.styleable.MyRatingBar_starImageSize,20);
        starPadding=a.getDimension(R.styleable.MyRatingBar_starPadding,10);
        starStep=a.getFloat(R.styleable.MyRatingBar_starStep,1.0f);
        stepSize= StepSize.fromStep(a.getInt(R.styleable.MyRatingBar_stepSize,1));
        starCount = a.getInteger(R.styleable.MyRatingBar_starCount, 5);
        starEmptyDrawable = a.getDrawable(R.styleable.MyRatingBar_starEmpty);
        starFillDrawable = a.getDrawable(R.styleable.MyRatingBar_starFill);
        starHalfDrawable = a.getDrawable(R.styleable.MyRatingBar_starHalf);
        mClickable = a.getBoolean(R.styleable.MyRatingBar_clickable, true);
        a.recycle();
    ...
    private ImageView getStarImageView() {
        ...
        //设置每颗星星在线性布局里的大小
        LayoutParams layout = new LayoutParams(Math.round(starImageSize), Math.round(starImageSize));
        //设置每颗星星的间距
