...
public abstract class BaseQuickAdapter<T, K extends BaseViewHolder> extends RecyclerView.Adapter<K> {
    //creat by shadow_li
    private QuickAdapterCallback callback;
    ...
    public void setCallback(QuickAdapterCallback callback) {
        if (callback != null) {
    ...
    public K onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            ...
            default:
                if (callback != null) {
                    baseViewHolder = (K) callback.onCreateViewHolder(parent, viewType);
                } else {
